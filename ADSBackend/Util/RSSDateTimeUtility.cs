...
namespace Scholarships.Util
{
    ...
    ///     the date-time formats implemented in the <see cref="RSSDateTimeUtility"/> class.
    /// </remarks>
    public static class RSSDateTimeUtility
    {
        //============================================================
        ...
        public static DateTime ParseRfc822DateTime(string value)
        {
            ...
            //	Parse RFC-3339 formatted date
            //------------------------------------------------------------
            if (RSSDateTimeUtility.TryParseRfc822DateTime(value, out result))
            {
                return result;
            }
            else
